    ...
    <>
      ...
      <div className="container-fluid bg-breadcrumb">
        <div className="container text-center py-5" style={{ maxWidth: '900px' }}>
          <h3 className="text-primary display-3 mb-4 wow animate__animated animate__fadeInDown" data-wow-delay="0.1s">Our Blog & News</h3>
      ...
      <div className="container-fluid blog py-5 bg-white">
        <div className="container py-5">
          <div className="pb-5">
            <h4 className="text-secondary sub-title fw-bold animate__animated animate__fadeInUp" data-wow-delay="0.1s">Blog & News</h4>
            <h1 className="display-2 mb-0 animate__animated animate__fadeInUp" data-wow-delay="0.3s">Our Latest News & Articles</h1>
          </div>
          <div className="blog-carousel owl-carousel pt-5 animate__animated animate__fadeInUp" data-wow-delay="0.1s">
            ...
            <div className="blog-item bg-white rounded animate__animated animate__fadeInUp" data-wow-delay="0.7s">
              <div className="blog-img rounded-top">
                <img src="/img/class-1.jpg" className="img-fluid rounded-top w-100" alt="Image" />
              </div>
              <div className="bg-light rounded-bottom p-4">
            ...
            {[1,3,2,4,3].map((num, idx) => (
              <div className="training-item bg-white rounded wow fadeInUp" data-wow-delay={`${0.1 + idx*0.2}s`} key={idx}>
                ...
                <div className="rounded-bottom border border-top-0 p-4">
                  ...
                  <p className="mb-3 text-muted">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni vero excepturi blanditiis quidem</p>
                  <a className="btn btn-primary rounded-pill text-white py-2 px-4" href="#">Read More</a>
                </div>
              </div>
            ))}
